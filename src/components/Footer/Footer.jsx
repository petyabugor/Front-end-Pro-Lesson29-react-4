            ...
            <div className="case__wrapper"> 
                    <div className="case__right">
                        <div className="case__right__column">
                            ...
                            <ul>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Оплата</a>
                                </li>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Обмін і повернення</a>
                                </li>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Карта сайту</a>
                                </li>
                            </ul>
                        </div>
                        <div className="case__right__column">
                            ...
                            <ul>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Магазини</a>
                                </li>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Блог</a>
                                </li>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Відгуки</a>
                                </li>
                            </ul>
                        </div>
                        <div className="case__right__column">
                            ...
                            <ul>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">
                                        <img src={inst} alt="" />
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div className="case__right__column">
                            ...
                            <ul>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">(091) 852-57-71</a>
                                </li>
                                <li className="case__right__column__item"> 
                                    <a href="#" className="case__right__column__link">Localize@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
